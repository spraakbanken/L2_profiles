...
* Under the first row of filters, there is a possibility to click on the CEFR level buttons to select items appearing at a particular level. Each button is of a _toggle_ character: first click selects the item, the second one de-selects it. Several levels can be selected simultaneously.
